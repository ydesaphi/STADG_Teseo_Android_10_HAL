...
void GeofencingManager::onDeviceStatusUpdate(GnssStatusValue deviceStatus)
{
    /*
    ...
    switch(deviceStatus)
    {
        //case GnssStatusValue::ENGINE_ON:
        case GnssStatusValue::SESSION_BEGIN:
            sendGeofenceStatus(SystemStatus::Available, m_lastLocation);
            break;

        //case GnssStatusValue::ENGINE_OFF:
        case GnssStatusValue::SESSION_END:
        case GnssStatusValue::NONE:
        default:
