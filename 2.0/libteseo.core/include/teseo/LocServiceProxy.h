...
namespace gps {
	...
	void sendSatelliteListUpdate_2_0(const std::map<SatIdentifier, SatInfo> & satellites);
...
namespace ril {
	...
	struct Signals {
		...
		Signal<void, NetworkAttributes> updateNetworkState_2_0 = Signal<void, NetworkAttributes> ("ril::signals::updateNetworkState_2_0");
	};
